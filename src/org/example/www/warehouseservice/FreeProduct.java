 ...
 */
    ...
    public static class Factory{
        ...
        */
        public static FreeProduct parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            FreeProduct object =
                new FreeProduct();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"freeProduct".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (FreeProduct)org.example.www.warehouseservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
